...
const LoginPageQuery = () => {
  ...
  const getCertMutation = useMutation(
    (data) => axios.post("https://htalk-api.helixtech.co.kr/auth/v1/cert/confirm/pw", data),
    {
      onSuccess: () => {
        console.log("success");
      },
  ...
  const getUserInformMutation = useMutation(
    (data) => axios.post("https://htalk-api.helixtech.co.kr/auth/v1/login/pw", data),
    {
      onSuccess: () => {
        console.log("success");
      },
